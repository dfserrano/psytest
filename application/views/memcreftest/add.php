				...
				for ($i = 1; $i<=$initial_slides; $i++):?>
					<div class="slide">
						...
						<div class="slide-info">
							<label for="type" class="slide-label"><?php echo $this->lang->line('label_type');?></label>
							<select id="type" name="type[]" class="text ui-widget-content ui-corner-all slide-input">
								<option value="1"><?php echo $this->lang->line('option_before');?></option>
								<option value="2"><?php echo $this->lang->line('option_after');?></option>
							</select>
							<br/>
