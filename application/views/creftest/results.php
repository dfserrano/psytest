    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        var dataRightWrong = google.visualization.arrayToDataTable([
			['<?php echo $this->lang->line('label_code');?>', '<?php echo $this->lang->line('label_num_right');?>', '<?php echo $this->lang->line('label_num_wrong');?>'],
			<?php 
        ...
        var dataTime = google.visualization.arrayToDataTable([
			['<?php echo $this->lang->line('label_code');?>', '<?php echo $this->lang->line('label_avg_time_right');?>', '<?php echo $this->lang->line('label_avg_time_wrong');?>', '<?php echo $this->lang->line('label_avg_time_total');?>'],
            <?php 
            foreach ($results as $code=>$result) {
