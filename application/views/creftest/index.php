<div id="main">
	<?php 
	$allowed_roles_add = array('admin', 'cref_admin');
	$allowed_roles_report = array('admin', 'cref_admin', 'cref_viewer');
			...
			<div class="test-item">
				...
				<div id="test-actions">
					...
					if ($username && in_array($role, $allowed_roles_report)) {
						...
						&nbsp;
						<a href="<?php echo site_url("creftest/edit/" . $test['id']);?>">[<?php echo $this->lang->line('edit');?>]</a>
						<?php 
					}
					?>
				</div>
